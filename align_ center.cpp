...
//////////////////////////////////////THIS FN WHICH BEHAVE LIKE SETW();////////////////////////////////
void setspace(int a)
{
    for (int i = 0; i<a; i++)
    {
...
void draw()
{
    ...
    setspace(45); cout << " _____________________________________________\n";
   setspace(45); cout <<  "|  ______ ______ ______ ______ ______ ______  |\n";
   setspace(45); cout <<  "| |      |      |      |      |      |      | |\n";
    cout << setw(51) <<" | |   " << board[0] << "  |   " << board[1] << "  |   " << board[2] << "  |   " <<board[3] <<"  |   " <<board[4]<<"  |   "<<board[5]<<"  | |   "<< "\n";
   setspace(45); cout << "| |______|______|______|______|______|______| |\n";
   setspace(45); cout << "| |      |      |      |      |      |      | |\n";
    cout << setw(51) <<" | |   " << board[6] << "  |   " << board[7] << "  |   " << board[8] << "  |   " <<board[9] <<"  |   "<<board[10]<<"  |   "<<board[11]<<"  | |  "<< "\n";
   setspace(45);cout << "| |______|______|______|______|______|______| | \n";
   setspace(45); cout << "| |      |      |      |      |      |      | |\n";
    cout << setw(51) <<" | |   " << board[12] << "  |   " << board[13] << "  |   " << board[14] << "  |   " <<board[15] <<"  |   "<<board[16]<<"  |   "<<board[17]<<"  | |  "<< "\n";
   setspace(45); cout << "| |______|______|______|______|______|______| | \n";
   setspace(45);cout << "| |      |      |      |      |      |      | |\n";
    cout << setw(51) <<" | |   " << board[18] << "  |   " << board[19] << "  |   " << board[20] << "  |   " <<board[21] <<"  |   "<<board[22]<<"  |   "<<board[23]<<"  | |   "<< "\n";
   setspace(45);cout << "| |______|______|______|______|______|______| | \n";
   setspace(45);cout << "| |      |      |      |      |      |      | |\n";
    cout << setw(51) <<" | |   " << board[24] << "  |   " << board[25] << "  |   " << board[26] << "  |   " <<board[27] <<"  |   "<<board[28]<<"  |   "<<board[29]<<"  | |   "<< "\n";
   setspace(45); cout << "| |______|______|______|______|______|______| | \n";
   setspace(45);cout << "| |      |      |      |      |      |      | |\n";
    cout << setw(51) <<" | |   " << board[30] << "  |   " << board[31] << "  |   " << board[32] << "  |   " <<board[33] <<"  |   "<<board[34]<<"  |   "<<board[35]<<"  | |   "<< "\n";
   setspace(45); cout << "| |______|______|______|______|______|______| | \n";
   setspace(45); cout << "|_____________________________________________|";
}
...
//Check whether the input is 5 or 10
    ...
    do
    {
        ...
        if(c % 2 == 0)
        {
            setspace(60);cout<<"Start player 1"<<endl;
            name = "player 1";
        }
        else
        {
            setspace(60);cout<<"Start player 2"<<endl;
            name = "player 2";
        }
        cout<<endl;
        setspace(40);cout<<name<<"'s available move according to rolling dice = "<<ran<<endl;
        j = 0;
      ...
      setspace(55);  cout<<"Conquer(by using aswd): ";
                getline(cin,in);
